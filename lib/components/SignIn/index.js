...
const SignIn = ({ goToForget, handleSignIn, goToSignUp, handleSocial, hideTabs = false, textFieldVariant = "filled", emailValidator = (e) => !!e, passwordValidator = (e) => !!e, }) => {
    ...
    return (React.createElement(Box, { p: 2 },
        ...
        React.createElement(Typography, { variant: "body2", color: "textSecondary", align: "right", style: { cursor: "pointer" }, onClick: goToForget }, "Esqueceu a senha?"),
        React.createElement(FormControl, { margin: "normal", fullWidth: true },
            React.createElement(Button, { onClick: handleSubmit, style: { textTransform: "none" }, size: "large", disabled: loading, variant: "contained", color: "primary", fullWidth: true }, "Entrar")),
        Object.values(handleSocial).some((v) => typeof v === "function") && (React.createElement(Typography, { variant: "subtitle2", color: "textSecondary", align: "center" }, "ou continue com")),
        ...
        hideTabs && (React.createElement(Typography, { variant: "body2", color: "textSecondary", align: "center", style: { cursor: "pointer" }, onClick: goToSignUp }, "Sem conta? Crie agora"))));
};
