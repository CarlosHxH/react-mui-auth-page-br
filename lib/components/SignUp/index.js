...
const SignUp = ({ handleSignUp, gobackToSignIn, textFieldVariant = "filled", hideTabs, emailValidator = (e) => !!e, passwordValidator = (e) => !!e, }) => {
    ...
    return (React.createElement(Box, { p: 2 },
        ...
        React.createElement(FormControl, { margin: "normal", fullWidth: true },
            React.createElement(Button, { style: { textTransform: "none" }, size: "large", variant: "contained", color: "primary", fullWidth: true, onClick: handleSubmit }, "Registre-se")),
        hideTabs && (React.createElement(Typography, { variant: "body2", color: "textSecondary", align: "center", style: { cursor: "pointer" }, onClick: gobackToSignIn }, "Volte para o login"))));
};
