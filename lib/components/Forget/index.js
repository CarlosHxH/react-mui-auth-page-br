...
const Forget = ({ gobackToSignIn, handleForget, textFieldVariant = "filled", emailValidator = (e) => !!e, }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(IconButton, { "aria-label": "volte", onClick: gobackToSignIn },
        ...
        React.createElement(Box, { p: 2, pb: 6 },
            React.createElement(Typography, { variant: "h6", color: "textSecondary", align: "center" },
                React.createElement("b", null, "Esqueça sua senha")),
            ...
            React.createElement(FormControl, { margin: "none", fullWidth: true },
                React.createElement(Button, { onClick: handleSubmit, style: { textTransform: "none" }, size: "large", variant: "contained", color: "primary", fullWidth: true }, "Resetar minha senha")))));
};
